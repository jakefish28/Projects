...
### Confidence Tiers
- High confidence (A grade horse, strong angle) = 5 percent of bankroll
- Medium confidence (B grade, solid but not certain) = 3 percent of bankroll
- Speculative (longshot play, value only) = 1 to 2 percent of bankroll
- Low confidence = do not bet. Pass the race.

## Passing Races
The best bettors pass more races than they bet.
You do not need to bet every race.
...
## The Winning Mindset
You are not trying to win every race.
You are trying to make money over many races by consistently finding value.
A 30 percent win rate with proper value selection is highly profitable.
A 50 percent win rate betting underlays loses money.

## End of Day Rule
At the end of the day calculate your profit or loss.
Note which bets worked and why.
Note which bets failed and why.
Heshie learns from this data over time.
